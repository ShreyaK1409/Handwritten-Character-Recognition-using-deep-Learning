...
classes = ['System Detected Character is A',
           'System Detected Character is B',
           'System Detected Character is C',
           'System Detected Character is D',
           'System Detected Character is E',
           'System Detected Character is F',
           'System Detected Character is G',
           'System Detected Character is H',
           'System Detected Character is I',
           'System Detected Character is J',
           'System Detected Character is K'
           ]
...
def userlog():
    ...
    if request.method == "POST":
        ...
        print('p')
        mydb = mysql.connector.connect(host="localhost", user="root", passwd="", database="hand_written")
        cursor = mydb.cursor()
...
def upload():
    ...
    fn=myfile.filename
    mypath=os.path.join('D:/Hand written/images/', fn)
    myfile.save(mypath)
    ...
    img="dataset/test/C/47.jpg"
    new_model = load_model(r'D:\Hand written\VGG16Model-1.h5',compile=True)
...
def send_image(filename):
    return send_from_directory("D:/Hand written/images", filename)
@app.route('/upload1')
def upload1():
